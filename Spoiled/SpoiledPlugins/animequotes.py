...
from telegram.ext import CallbackContext, CommandHandler, filters as Filters, CallbackQueryHandler
...
async def quotes(update: Update, context: CallbackContext):
...
async def change_quote(update: Update, context: CallbackContext):
...
Yashu.add_handler(CommandHandler("quotes", quotes))
Yashu.add_handler(CommandHandler("animequotes", animequotes))
Yashu.add_handler(CallbackQueryHandler(change_quote, pattern=r"change_.*"))
Yashu.add_handler(CallbackQueryHandler(change_quote, pattern=r"quote_.*"))
