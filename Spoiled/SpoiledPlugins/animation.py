...
Yashu.add_handler(CommandHandler("kill", kill))
Yashu.add_handler(CommandHandler("love", love))
Yashu.add_handler(CommandHandler("hack", hack))
Yashu.add_handler(CommandHandler("bombs", bombs))
Yashu.add_handler(CommandHandler("moon", moonanimation))
Yashu.add_handler(CommandHandler("clock", clockanimation))
Yashu.add_handler(CommandHandler("block", blockanimation))
Yashu.add_handler(CommandHandler("earth", earthanimation))
