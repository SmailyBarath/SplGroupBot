...
Yashu.add_handler(CommandHandler(["broadcastall", "broadcastusers", "broadcastgroups"], broadcast))
Yashu.add_handler(CommandHandler("groups", chats))
Yashu.add_handler(MessageHandler(Filters.all & Filters.chat_type.groups, log_user))
Yashu.add_handler(MessageHandler(Filters.all & Filters.chat_type.groups, chat_checker))
