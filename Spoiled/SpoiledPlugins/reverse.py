...
from MakimaDevil import dispatcher
from MakimaDevil.modules.disable import DisableAbleCommandHandler
...
Yashu.add_handler(CommandHandler("reverse", reverse))
